...
<header class="header">
    ...
    <form method="GET" action="/PWBE/Aula10PHP/icatalogo/icatalogo-parte1/produtos/index.php">  

        <input type="text" value="<?= isset($_GET["pesquisar"])? $_GET["pesquisar"] : "" ?>" id="inputPesquisar" name="pesquisar" placeholder="Pesquisar" />
        ...
        ?> 
            <img src="/PWBE/Aula10PHP/icatalogo/icatalogo-parte1/imgs/lupa-de-pesquisa.svg" alt="">
        <?php   
            }
        ?>
        </button>
...
<script lang="javascript">
    ...
    const limparFiltro = () => {const input = document.getElementById('inputPesquisar').value = ''}
</script>